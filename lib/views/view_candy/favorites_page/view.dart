...
List<CategorytDTO> categoryFavorit = [];
...
class FavoritesPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<FavoritesItemCubit, FavoritesItemState>(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: categoryFavorit.isEmpty
                            ? 1
                            : categoryFavorit.length,
                            ...
                            return Container(
                              ...
                              child: const Column(
                                children: [
                                  ...
                                  CustomImageWidget(
                                    imagePath:
                                        "assets/images/view/feed_back.svg",
                                    height: 282,
                                    width: 260,
                                  ),
                                  SizedBox(height: 24),
